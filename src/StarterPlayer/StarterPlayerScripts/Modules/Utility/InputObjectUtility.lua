--[=[
	...
	@class InputObjectUtility
]=]

local InputObjectUtility = {}
...
function InputObjectUtility.IsMouseUserInputType(userInputType)
...
function InputObjectUtility.IsSameInputObject(inputObject, otherInputObject)
...
table.freeze(InputObjectUtility)
return InputObjectUtility
