...
local IndicesReference = Symbol.new("IndicesReference")
...
--[=[
	...
	the Janitor will "link" the Instance without overwriting any previous links, and will also not be overridable.
