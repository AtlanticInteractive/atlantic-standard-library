...
function Debug.AlphabeticalOrder(Dictionary: GenericDictionary)
	local Order = {}
	local Length = 0
...
function Debug.TableToString(Table: GenericTable, Multiline: boolean?, TableName: string?): string
...
function Debug.EscapeString(String: string): string
	return (string.gsub(string.gsub(String, Escapable, "%%%1"), "([\"'\\])", "\\%1")) :: string
end
