...
local WithState = require(script.Parent.Parent.Hooks.WithState)
...
local function Component(ComponentMethods: Types.ClassComponentMethods)
	local DefaultProperties = ComponentMethods.DefaultProperties
	local MetatableIndex = {__index = ComponentMethods}

	return WithState(function(GetState, SetState, SubscribeState)
