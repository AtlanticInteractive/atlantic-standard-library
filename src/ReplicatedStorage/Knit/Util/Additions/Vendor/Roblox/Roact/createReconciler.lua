...
local function createReconciler(renderer)
	...
	local function updateChildren(virtualNode, hostParent, newChildElements)
		...
		local currentUpdateChildrenCount = virtualNode.updateChildrenCount + 1
		virtualNode.updateChildrenCount = currentUpdateChildrenCount
	...
	local function updateVirtualNodeWithRenderResult(virtualNode, hostParent, renderResult)
		if renderResult == nil or type(renderResult) == "boolean" or Type.of(renderResult) == Type.Element then
	...
	function updateVirtualNode(virtualNode, newElement, newState)
		...
		if config.typeChecks then
			assert(
				newElement == nil or type(newElement) == "boolean" or Type.of(newElement) == Type.Element,
	...
	local function createVirtualNode(element, hostParent, hostKey, context, legacyContext)
		if config.internalTypeChecks then
			...
			internalAssert(context == nil or type(context) == "table", "Expected arg #4 to be of type table or nil")
			internalAssert(
				legacyContext == nil or type(legacyContext) == "table",
		...
		if config.typeChecks then
			...
			assert(
				type(element) == "boolean" or Type.of(element) == Type.Element,
