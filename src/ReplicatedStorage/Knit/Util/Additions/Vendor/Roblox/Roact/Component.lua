...
function Component:__mount(reconciler, virtualNode)
	...
	local internalData = {}
	internalData.reconciler = reconciler
	internalData.virtualNode = virtualNode
	internalData.componentClass = self
	internalData.lifecyclePhase = ComponentLifecyclePhase.Init
...
function Component:__update(updatedElement, updatedState)
	if config.internalTypeChecks then
		...
		internalAssert(
			updatedState == nil or type(updatedState) == "table",
