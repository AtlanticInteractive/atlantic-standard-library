...
function QFrame.FromCFrameClosestTo(cframe, closestTo)
	...
	assert(QFrame.Is(closestTo), "Bad closestTo")
...
function QFrame.__add(a, b)
	assert(QFrame.Is(a) and QFrame.Is(b),
...
function QFrame.__pow(a, b)
	assert(QFrame.Is(a) and type(b) == "number", "Bad a or b")
