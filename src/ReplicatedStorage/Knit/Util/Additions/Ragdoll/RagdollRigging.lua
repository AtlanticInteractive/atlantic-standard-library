--[=[
	Rigging data for humanoid ragdolls.
...
function RagdollRigging.RemoveRagdollJoints(model)
	for _, descendant in ipairs(model:GetDescendants()) do
		...
		if (descendant:IsA("BallSocketConstraint") and descendant.Name == BALL_SOCKET_NAME) or (descendant:IsA("NoCollisionConstraint") and descendant.Name == NO_COLLIDE_NAME) then
			descendant:Destroy()
		end
	end
end
