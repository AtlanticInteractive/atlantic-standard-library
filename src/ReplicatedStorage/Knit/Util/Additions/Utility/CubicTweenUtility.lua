--[=[
	...
	@class CubicTweenUtility
]=]

local CubicTweenUtility = {}
...
function CubicTweenUtility.GetConstants(l, t)
	local r = l - t
...
function CubicTweenUtility.GetDerivativeConstants(l, t)
	local r = l - t
...
function CubicTweenUtility.ApplyConstants(c0, c1, c2, c3, a, u, b, v)
...
function CubicTweenUtility.Tween(a, u, b, v, l, t)
	local a0, a1, a2, a3 = CubicTweenUtility.GetConstants(l, t)
...
function CubicTweenUtility.GetAcceleration(a, u, b, v, l)
	return (12 * (b - a) * (b - a) - 12 * l * (b - a) * (u + v) + 4 * l * l * (u * u + u * v + v * v)) / (l * l * l)
end

table.freeze(CubicTweenUtility)
return CubicTweenUtility
