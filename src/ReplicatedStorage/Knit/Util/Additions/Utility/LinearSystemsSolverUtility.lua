--[=[
	@class LinearSystemsSolverUtility
]=]

local LinearSystemsSolverUtility = {}
...
function LinearSystemsSolverUtility.Solve(mutSystem, mutOutput)
	local n = #mutSystem
...
function LinearSystemsSolverUtility.SolveTridiagonal(mutMainDiag, mutUpperDiag, mutLowerDiag, mutOutput)
	local n = #mutMainDiag
...
table.freeze(LinearSystemsSolverUtility)
return LinearSystemsSolverUtility
