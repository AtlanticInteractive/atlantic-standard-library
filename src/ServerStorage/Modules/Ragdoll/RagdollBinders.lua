...
local PlayerHumanoidBinder = require(ServerStorage.Modules.PlayerHumanoidBinder)
...
return BinderProvider.new(function(self)
	...
	self:Add(PlayerHumanoidBinder.new("Ragdollable", FastRequire(script.Parent.Classes.Ragdollable)))
	...
	self:Add(PlayerHumanoidBinder.new("RagdollHumanoidOnDeath", FastRequire(script.Parent.Classes.RagdollHumanoidOnDeath)))
	...
	self:Add(PlayerHumanoidBinder.new("RagdollHumanoidOnFall", FastRequire(script.Parent.Classes.RagdollHumanoidOnFall)))
	...
	self:Add(PlayerHumanoidBinder.new("UnragdollAutomatically", FastRequire(script.Parent.Classes.UnragdollAutomatically)))
end)
